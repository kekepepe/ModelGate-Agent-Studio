...
| 项 | 数值 |
|---|---:|
| 后端 pytest | **451 passed, 1 skipped, 0 failures**（V1.0 末态 411） |
| 前端测试 | **183 passed / 38 文件**（V1.0 末态实际有 16 个失败测试被 vitest 别名缺失掩盖，已修复） |
...
| Working tree | **干净** |
| V1.0.1/V1.1/V1.2 期间新增 commit | 17（`c4e8f91` 起） |
...
| `docs/e2e-docker-stack.md` | docker compose + e2e 操作指南 |
...
> ⚠️ 2026-09-15 起：V1.0.1 / V1.1 已完成（计划留档 [`V1.0.1-V1.1-plan.md`](./V1.0.1-V1.1-plan.md)）；**当前阶段为 V1.2 本地 Memory / RAG 检索 / Skill 沉淀**，计划与进度见 [`V1.2-Memory-RAG-Skill-plan.md`](./V1.2-Memory-RAG-Skill-plan.md)（参考 mem0 / Voyager / Claude Agent Skills 等高星项目调研）。**当前阶段为 V1.2.1（Architecture Alignment + CI + Product Acceptance）**，计划见 [`V1.2.1-plan.md`](./V1.2.1-plan.md)；全局路线见 [`ROADMAP.md`](./ROADMAP.md)。⚠️ 本文件将在 V1.2.1 P0 中重构为标准交接文档。下面保留原始路线图供总览。
