  ...
  const handleSave = (data: AgentCreateData | AgentUpdateData) => {
    ...
    if (editingAgent) {
      ...
      const createData: AgentCreateData = {
        ...
        capability_profile: (data as AgentCreateData).capability_profile,
        workspace_permissions: (data as AgentCreateData).workspace_permissions,
        input_types: (data as AgentCreateData).input_types,
        output_types: (data as AgentCreateData).output_types,
        max_concurrency: (data as AgentCreateData).max_concurrency,
